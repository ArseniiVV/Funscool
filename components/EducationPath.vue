...
const slides = ref([
  {
    id: 1,
    head: 'Гибкость и Адаптация',
    headIcon: '/img/ui-elements/education-path-svg-1.svg',
    text: `<b>Система мягкой адаптации</b><br>
          Помогает ребёнку постепенно привыкнуть к новому месту: научиться «отпускать» родителя, подружиться с воспитателями и найти первых друзей.
          <br>
          <b>Дневник адаптации</b><br>
          Вместе с семьёй мы планируем каждый день, фиксируем советы и празднуем достижения ребёнка.
          <br>
          <b>Выездные мероприятия и мастер-классы</b><br>
          Экскурсии, спектакли, приглашённые специалисты — ребёнок расширяет свой кругозор и учится понимать мир вокруг, а не только стены детского сада.`,
    buttonText: 'Оставить заявку',
    color: '#00CCCC',
  },
  {
    id: 2,
    head: 'Развитие в Игре и творческой деятельности',
    headIcon: '/img/ui-elements/education-path-svg-2.svg',
    text: `<b>24 годовые темы</b><br>
          Авторская интегрированная программа последовательно знакомит с происхождением и развитием Земли, природой и экологией, ролью человека в окружающем мире.
          <br>
          <b>Творческие и социальные проекты</b><br>
          Дерево семьи и группы, волонтёрские инициативы и первые шаги в дружбе, поддержке и милосердии.
          <br>
          <b>Игровая форма обучения</b><br>
          Развиваем речь, учимся читать и писать, осваиваем арифметику и геометрию, тренируем сенсорику, внимание и память.
          <br>
          <b>Билингвальный подход</b><br>
          Вторая половина дня проходит на английском языке: те же темы, но в новом языковом формате. Так у детей естественно формируется словарный запас и коммуникативные навыки.`,
    buttonText: 'Оставить заявку',
    color: '#FEB200',
  },
  {
    id: 3,
    head: 'Персонализированное Обучение',
    headIcon: '/img/ui-elements/education-path-svg-5.svg',
    text: `<b>Диагностика интересов</b><br>
          На старте педагоги и методисты изучают сильные стороны и увлечения ребёнка, чтобы учесть их в образовательном процессе.
          <br>
          <b>Уникальный маршрут</b><br>
          Включает общий подход к малышу и определенные активности со стороны воспитателя, дополнительные кружки и секции, сопровождение психолога и логопеда по необходимости, а также рекомендации для родителей.
          <br>
          <b>Регулярная корректировка</b><br>
          Диагностика навыков и умений помогает вовремя менять режим посещения, набор кружков или стиль занятий, чтобы обучение оставалось интересным и эффективным.
          <br>
          <b>Поддержка дома</b><br>
          При необходимости мы даём родителям советы по коррекции поведения и развитию когнитивных функций, чтобы вместе достичь наилучшего результата.`,
    buttonText: 'Оставить заявку',
    color: '#FF6600',
  },
  {
    id: 4,
    head: 'Регулярная Поддержка Наставников (методиста, старшего воспитателя, психолога и логопеда):',
    headIcon: '/img/ui-elements/education-path-svg-4.svg',
    text: `<b>Наставники — педагоги, методисты, психологи, логопеды</b><br>
          Создают вдохновляющую атмосферу, сопровождают ребёнка на каждом этапе пути.
          <br>
          <b>Дополнительные занятия</b><br>
          При необходимости мы организуем индивидуальные уроки с логопедом, дефектологом или психологом.
          <br>
          <b>Герои Фанскул</b><br>
          Любимые персонажи помогают ребятам преодолевать страхи, учат дружбе и взаимопомощи, превращают адаптацию в увлекательное приключение.
          <br>
          <b>Система психологических сказок</b><br>
          Мы разрабатываем серию историй и игр, которые в будущем с радостью предложим и родителям, чтобы эти истории продолжались для ребёнка и дома.`,
    buttonText: 'Оставить заявку',
    color: '#6600CC',
  },
]);
...
const currentBgColor = ref(slides.value[0]?slides.value[0].color:'#00CCCC');
...
function onSlideChange(swiper: SwiperType) {
  ...
  currentBgColor.value = slides.value[swiper.realIndex]?.color ?? '#00CCCC';
}
