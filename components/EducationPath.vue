...
const slides = ref([
  {
    id: 1,
    head: 'Интеллект: логика и математика',
    headIcon: '/img/ui-elements/education-path-svg-1.svg',
    text: `<p>В школе Фанскул мы верим в уникальность каждого ребёнка и строим индивидуальный образовательный маршрут.</p>
           <p>Фокус на аналитическом мышлении, логике и уверенности в решении задач.</p>`,
    buttonText: 'Записаться на экскурсию',
    color: 'rgba(0, 204, 204, 1)',
  },
  {
    id: 2,
    head: 'Творчество: искусство и креативность',
    headIcon: '/img/ui-elements/education-path-svg-2.svg',
    text: `<p>Развиваем воображение через искусство, музыку и проекты, где ребёнок может смело пробовать новое.</p>`,
    buttonText: 'Записаться на экскурсию',
    color: 'rgba(254, 178, 0, 1)',
  },
  {
    id: 3,
    head: 'Спорт: физическая активность',
    headIcon: '/img/ui-elements/education-path-svg-5.svg',
    text: `<p>Закладываем привычку к движению: зарядка, игровые тренировки и дисциплина через командные активности.</p>`,
    buttonText: 'Записаться на экскурсию',
    color: 'rgba(255, 102, 0, 1)',
  },
  {
    id: 4,
    head: 'Личность: уверенность и мышление',
    headIcon: '/img/ui-elements/education-path-svg-4.svg',
    text: `<p>Работаем над эмоциональным интеллектом, коммуникацией и самостоятельностью вместе с психологом и наставником.</p>
