      ...
      meta: [
        {
          name: 'description',
          content:
            'Фанскул — частный детский сад Уфа: уютная атмосфера, заботливые воспитатели, безопасность, здоровое развитие, мягкая адаптация, мини-группы, занятия для дошкольников, развитие речи и мышления, творчество, спорт, подготовка к школе, английский для детей.',
        },
