...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: 'Фанскул - Уютный детский сад для гармоничного развития ребёнка', // todo: Устанавливаем заголовок страницы
      htmlAttrs: {
      ...
      meta: [
        {
          name: 'description',
          content:
            'Фанскул — частный детский сад Москва (Раменки, Хамовники, Фили, Народное Ополчение): уютная атмосфера, заботливые воспитатели, безопасность, здоровое развитие, мягкая адаптация, мини-группы, занятия для дошкольников, развитие речи и мышления, творчество, спорт, подготовка к школе, английский для детей.',
        },
